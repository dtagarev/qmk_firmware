...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_split_3x6_3(KC_TAB, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_LSFT, KC_1, KC_2, KC_3, KC_4, KC_5, KC_MINS, KC_EQL, KC_BSLS, KC_LBRC, KC_RBRC, KC_GRV, KC_LCTL, KC_6, KC_7, KC_8, KC_9, KC_0, KC_UNDS, KC_PLUS, KC_PIPE, KC_LCBR, KC_RCBR, RALT_T(KC_TILD), KC_LALT, KC_TRNS, KC_SPC, KC_ENT, MO(3), KC_LGUI),
